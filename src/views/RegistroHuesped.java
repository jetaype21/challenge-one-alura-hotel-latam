...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuespedes () {
		if(txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
			...
			int num_reserva = Integer.parseInt(txtNreserva.getText());
			Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechaNacimiento, txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), num_reserva);
